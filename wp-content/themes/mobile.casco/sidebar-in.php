 <?php
        ...
        echo'
            ...
            echo '<div class="main_nav"><div id="insidecasco">';
            foreach ($childpage as $children) {
                ...
                if ($child_name == 'news')
                    echo '<ul id="secn-'.$child_name.'"><li><a href="#newsPage" data-transition="fade" id="news">'.$child_title.'</a></li></ul>';
                else
                    echo '<ul id="secn-'.$child_name.'"><li><a class="'.$child_title.'" href="#inPage" id="'.$child_name.'" data-transition="fade">'.$child_title.'</a></li></ul>';
            }
            echo '</div><!--end insidecasco--></div><!--end main_nav--><div id="inside_content">'; 