            ...
            function InitPuzzle(){
                ...
                for (var intRowIndex = 0 ; intRowIndex < intRows ; intRowIndex++){
                    ...
                    for (var intColIndex = 0 ; intColIndex < intColumns ; intColIndex++){
						...
						var posTop = intSize * intRowIndex;
						var posLeft = intSize * intColIndex;
						
						if (intRowIndex == 0 && intColIndex == 0){pieceNumber = 1;}
						else if (intRowIndex == 0 && intColIndex == 1){pieceNumber = 2;}
						else if (intRowIndex == 0 && intColIndex == 2){pieceNumber = 3;}
						else if (intRowIndex == 1 && intColIndex == 0){pieceNumber = 4;}
						else if (intRowIndex == 1 && intColIndex == 1){pieceNumber = 5;}
						else if (intRowIndex == 1 && intColIndex == 2){pieceNumber = 6;}
						else if (intRowIndex == 2 && intColIndex == 0){pieceNumber = 7;}
						else if (intRowIndex == 2 && intColIndex == 1){pieceNumber = 8;}
						else if (intRowIndex == 2 && intColIndex == 2){pieceNumber = 9;}
                        ...
                        jPiece = $( "<div class='piece' id='"+pieceNumber+" "+posTop+" "+posLeft+"'><br /></div>" );
