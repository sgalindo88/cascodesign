...
<!--*****************************START ACTION PAGE CONTENT_***************************************-->   
    ...
    ?>
<?php    
//get all projects of a single client
$query_clients = new WP_Query( 'tag='.$tag_name);
    echo '<h1 id="in-title">'.$tag_title.'</h1>';
    echo '<ul class="clients-list" data-role="listview" data-insert="true" data-filter="true">';
...
?>
    <br/>
    <small id="back-btn"><a href="" data-rel="back" data-transition="fade">Back</a></small>
    </div>
